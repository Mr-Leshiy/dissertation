...
double Solution2::cos_integration(const double& a, const double& b, const double& alpha_n, double(*f) (double))
{
...
void Solution2::calculate_coef(const double& alpha_n, double& C1, double& C2, double& C3, double& C4)
{
	double pn = cos_integration(0, a, alpha_n, load_function);
	...
	double det = 32 * alpha_pow_4 * b * e * G * mu_0_pow_4 + 160 * alpha_pow_4 * b * e * G * mu_0_pow_2 * mu_0 + 256 * alpha_pow_4 * b * e * G * mu_0_pow_2 + 128 * alpha_pow_4 * b * e * G * mu_0
		+ 8 * alpha_pow_2 * alpha_n * e * e * G * mu_0_pow_2 * mu_0 + 40 * alpha_pow_2 * alpha_n * e * e * G * mu_0_pow_2 + 64 * alpha_pow_2 * alpha_n * e * e * G * mu_0 + 32 * alpha_pow_2 * alpha_n * e * e * G
		+ 8 * alpha_pow_2 * alpha_n * e * e * lambda * mu_0_pow_2 * mu_0 + 40 * alpha_pow_2 * alpha_n * e * e * lambda * mu_0_pow_2 + 64 * alpha_pow_2 * alpha_n * e * e * lambda * mu_0
		+ 32 * alpha_pow_2 * alpha_n * e * e * lambda - 8 * alpha_pow_2 * alpha_n * G * mu_0_pow_2 * mu_0 - 40 * alpha_pow_2 * alpha_n * G * mu_0_pow_2 - 64 * alpha_pow_2 * alpha_n * G * mu_0
		- 32 * alpha_pow_2 * alpha_n * G - 8 * alpha_pow_2 * alpha_n * lambda * mu_0_pow_2 * mu_0 - 40 * alpha_pow_2 * alpha_n * lambda * mu_0_pow_2 - 64 * alpha_pow_2 * alpha_n * lambda * mu_0
		- 32 * alpha_pow_2 * alpha_n * lambda;
	det /= -e;
	...
	double detC2 = 16 * alpha_pow_4 * b * e * mu_0_pow_4 * pn + 64 * alpha_pow_4 * b * e * mu_0_pow_2 * mu_0 * pn + 80 * alpha_pow_4 * b * e * mu_0_pow_2 * pn + 32 * alpha_pow_4 * b * e * mu_0 * pn
		+ 16 * alpha_pow_4 * b * mu_0_pow_4 * pn + 64 * alpha_pow_4 * b * mu_0_pow_2 * mu_0 * pn + 80 * alpha_pow_4 * b * mu_0_pow_2 * pn + 32 * alpha_pow_4 * b * mu_0 * pn
		+ 16 * alpha_pow_2 * alpha_n * e * mu_0_pow_4 * pn + 80 * alpha_pow_2 * alpha_n * e * mu_0_pow_2 * mu_0 * pn + 144 * alpha_pow_2 * alpha_n * e * mu_0_pow_2 * pn + 112 * alpha_pow_2 * alpha_n * e * mu_0 * pn
		+ 32 * alpha_pow_2 * alpha_n * e * pn - 16 * alpha_pow_2 * alpha_n * mu_0_pow_4 * pn - 80 * alpha_pow_2 * alpha_n * mu_0_pow_2 * mu_0 * pn - 144 * alpha_pow_2 * alpha_n * mu_0_pow_2 * pn
		- 112 * alpha_pow_2 * alpha_n * mu_0 * pn - 32 * alpha_pow_2 * alpha_n * pn;
	detC2 /= e1;
...
double Solution2::function_Un(double y, double alpha_n)
{
	double result = 0;
...
double Solution2::function_Vn(double y, double alpha_n)
{
	double result = 0;
...
double Solution2::function_U(double x, double y)
{
	double result = 0, prev_result = 0;
...
double Solution2::function_V(double x, double y)
{
	double result = 0, prev_result = 0;
...
double Solution2::derivative_Ux(double x, double y)
{
	double result = 0, prev_result = 0;
...
double Solution2::derivative_Vn(double y, double alpha_n)
{
	double result = 0;
...
double Solution2::derivative_Vy(double x, double y)
{
	double result = 0, prev_result = 0;
...
double Solution2::sigma_Y(double x, double y)
{
...
double Solution2::sigma_X(double x, double y)
{
	double dUx = derivative_Ux(x, y);
	double dVy = derivative_Vy(x, y);
